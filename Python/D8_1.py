    ...
    for locations in antennas.values():
        ...
        for i in range(n - 1):
            for j in range(i + 1, n):
                ...
                possible_loc_1 = (location_1[0] - diff_0, location_1[1] - diff_1)
                possible_loc_2 = (location_2[0] + diff_0, location_2[1] + diff_1)

                if possible_loc_1[0] >= 0 and possible_loc_1[0] < nb_rows and\
                    possible_loc_1[1] >= 0 and possible_loc_1[1] < nb_cols:
                    antinodes.add(possible_loc_1)
                
                if possible_loc_2[0] >= 0 and possible_loc_2[0] < nb_rows and\
